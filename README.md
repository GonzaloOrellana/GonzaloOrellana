...
- 🎓 Cursando la **Lic. en Gestión de Tecnología de la Información** en **UADE**.
- 📊 Formándome en **Análisis de Datos con Python**.
- 💻 Desarrollador **Frontend Freelance** y apasionado por el **Diseño UI/UX**.
- 🎬 También edito video con **Premiere Pro** y **After Effects** para creadores de contenido.
- ⚡ Buscando siempre crear experiencias digitales con código limpio, responsivo y estético.
